...
{
    /// <summary>
    /// Generates basic division problems of the form: x / y
    /// </summary>
    public class DMQ_SimpleDivisionNoNeg : DynamicMathQuestion
    {
        private const int MIN_VARRESULT = 1;
        private const int MAX_VARRESULT = 11;
        private const int NOMINATOR_MAX = 20;
        ...
        public override string[] GetContent()
        {
            ...
            // provide a hint text
            content[5] = "This is the hint for basic division";
