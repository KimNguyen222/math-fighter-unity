...
{
    /// <summary>
    /// Generates intermediate division problems of the form: x / y
    /// </summary>
    public class DMQ_SimpleDivisionIntermediate : DynamicMathQuestion
    {
        private const int MIN_VARRESULT = 1;
        private const int MAX_VARRESULT = 26;
        private const int NOMINATOR_MAX = 50;
        ...
        public override string[] GetContent()
        {
            ...
            // provide a hint text
            content[5] = "This is the hint for intermediate division";
