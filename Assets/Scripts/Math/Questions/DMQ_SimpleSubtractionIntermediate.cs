...
{
    /// <summary>
    /// Generates intermediate subtraction problems if the form: x - y
    /// </summary>
    public class DMQ_SimpleSubtractionIntermediate : DynamicMathQuestion
    {
        private const int MIN_VAR1 = 52;
        private const int MAX_VAR1 = 100;
        private const int MIN_VAR2 = 51;
        ...
        public override string[] GetContent()
        {
            ...
            // provide a hint text
            content[5] = "This is the hint for intermediate subtraction";
