...
{
    /// <summary>
    /// Generates intermediate addition problems if the form: x + y
    /// </summary>
    public class DMQ_SimpleAdditionIntermediate : DynamicMathQuestion
    {
        private const int MIN_VAR1 = 51;
        ...
        public override string[] GetContent()
        {
            ...
            // provide a hint text
            content[5] = "This is the hint for intermediate addition";
