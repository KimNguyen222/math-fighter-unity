...
{
    /// <summary>
    /// Generates intermediate multiplication problems of the form: x * y
    /// </summary>
    public class DMQ_SimpleMultiplicationIntermediate : DynamicMathQuestion
    {
        private const int MIN_VAR1 = 0;
        private const int MAX_VAR1 = 9;
        private const int MIN_VAR2 = 0;
        private const int MAX_VAR2 = 9;
        ...
        public override string[] GetContent()
        {
            ...
            // provide a hint text
            content[5] = "This is the hint for intermediate multiplication";
