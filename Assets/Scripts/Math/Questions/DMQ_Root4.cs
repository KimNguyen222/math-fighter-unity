...
{
    /// <summary>
    /// Evaluate the fourth root of a number
    /// </summary>
    public class DMQ_Root4 : DynamicMathQuestion
    {
        ...
        public override string[] GetContent()
        {
            ...
            // create the question
            content[0] = WrapMathString((answer * answer * answer * answer).ToString() + " ROOT 4");
            ...
            // provide a hint text
            content[5] = "This is the hint for fourth roots";
