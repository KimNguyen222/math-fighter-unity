...
{
    /// <summary>
    /// Player must find the value of an addition problem that includes one or more terms
    /// of the kind |x|.  There will be two terms and there can be four cases: "|x + y|",
    /// "|x| + y", "x + |y|", and "|x| + |y|".
    /// </summary>
    public class DMQ_AbsoluteValuesAddition : DynamicMathQuestion
    {
        ...
        public override string[] GetContent()
        {
            ...
            switch (_rnd.Next(0, 4))
            {
                ...
                case 2: // x + |y|
                    ...
                    question = var1.ToString() + " + " + (prefixNeg2 ? "-" : "") + "`" + var2 + "`";
                ...
                case 3: // |x| + |y|
                    prefixNeg1 = (_rnd.Next(2) == 0);
                    prefixNeg2 = (_rnd.Next(2) == 0);
                    question = (prefixNeg1 ? "-" : "") + "`" + var1 + "` + " + (prefixNeg2 ? "-" : "") + "`" + var2 + "`";
            ...
            // provide a hint text
            content[5] = "This is the hint for absolute value addition";
