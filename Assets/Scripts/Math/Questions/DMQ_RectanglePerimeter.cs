...
namespace MathFighter.Math.Questions
{
    ...
    public class DMQ_RectanglePerimeter : DynamicMathQuestion
    {
        ...
        public override string[] GetContent()
        {
            ...
            if (length1 == length2)
            {
                content[0] = "A square with sides of " + length1 + " inches has a perimeter of?";
            }
            else
            {
                content[0] = "A " + length1 + " inch by " + length2 + " inch rectangle has a perimeter of?";
            }

            // fill in the correct answer
            content[1] = answer.ToString() + " inches";
            ...
            for (int i = 2; i < 5; i++)
            {
                ...
                do
                {
                    ...
                    rep = (answer + pertubation).ToString() + " inches";
