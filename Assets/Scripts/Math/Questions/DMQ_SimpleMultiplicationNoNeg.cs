...
{
    /// <summary>
    /// Generates basic multiplication problems of the form: x * y
    /// </summary>
    public class DMQ_SimpleMultiplicationNoNeg : DynamicMathQuestion
    {
        private const int MIN_VAR1 = 0;
        private const int MAX_VAR1 = 5;
        private const int MIN_VAR2 = 0;
        private const int MAX_VAR2 = 5;
        ...
        public override string[] GetContent()
        {
            ...
            // provide a hint text
            content[5] = "This is the hint for basic multiplication";
