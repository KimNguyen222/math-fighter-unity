...
{
    /// <summary>
    /// Player must multipy the two fractions (the result is also reduced to it's simplest form)
    /// </summary>
    public class DMQ_FractionsMultiplication : DynamicMathQuestion
    {
        ...
        public override string[] GetContent()
        {
            ...
            // provide a hint text
            content[5] = "This is the hint for Fractions Multiply";
