    ...
    public class MathOperatorDivide : MathOperator
    {
        ...
        public override void AdjustDivisionParamsForIntegerResult()
        {
            ...
            if (value2 == 0.0f)
            {
                ...
                if (!(RightParam is MathOperatorParenthesis))
                    Debug.Log("righthand param is expected to be parentheses");
                ...
                if (value2 != 1)
                    Debug.Log("righthand param should evaluate to 1");
            }
        ...
        public override MathElement Simplify_SubtractExponents()
        {
            ...
            if (leftElement.EqualsSubtree(rightElement))
            {
                ...
                {
                    Debug.Log("Unhandled case in Simplify_SubtractExponents()");
                }
            }
        ...
        public override MathElementView GenerateView(float h, float spacing, Font font)
        {
            switch (_displayType)
            {
                ...
                default:
                    Debug.Log("Unrecognized display type for division operator: " + _displayType);
